...
-- ============================================================
-- Equivalente de 02_datos.sql (SQLite 3). Los INSERT son
-- compatibles tal cual; las fechas se almacenan ahora en
-- columnas DATE (PostgreSQL acepta los literales 'YYYY-MM-DD').
