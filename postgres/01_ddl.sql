...
-- ============================================================
-- Equivalente de 01_ddl.sql (SQLite 3).
-- Cambios respecto a SQLite:
--   * INTEGER PRIMARY KEY AUTOINCREMENT
--       -> INTEGER GENERATED BY DEFAULT AS IDENTITY
--   * REAL (float de 8 bytes en SQLite)
--       -> DOUBLE PRECISION
--   * Fechas almacenadas como TEXT
--       -> DATE (tipo nativo de PostgreSQL)
--   * Se agrega CASCADE a los DROP para que el script sea
--     reejecutable sin importar el estado previo del esquema.
-- ============================================================

-- ------------------------------------------------------------
-- Limpieza de objetos previos
-- ------------------------------------------------------------
DROP VIEW IF EXISTS vw_personal_terreno_activo CASCADE;
DROP TABLE IF EXISTS Uso_Materiales CASCADE;
DROP TABLE IF EXISTS Asignacion_Empleados CASCADE;
DROP TABLE IF EXISTS Materiales CASCADE;
DROP TABLE IF EXISTS Proveedores CASCADE;
DROP TABLE IF EXISTS Etapas_Proyecto CASCADE;
DROP TABLE IF EXISTS Proyectos_Residenciales CASCADE;
DROP TABLE IF EXISTS Proyectos_Comerciales CASCADE;
DROP TABLE IF EXISTS Proyectos CASCADE;
DROP TABLE IF EXISTS Telefonos_Empleado CASCADE;
...
CREATE TABLE Empleados (
    ...
    sueldo_hora DOUBLE PRECISION NOT NULL
        CHECK (sueldo_hora > 0)
);
...
CREATE TABLE Telefonos_Empleado (
    id_telefono INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Proyectos (
    ...
    precio_mts2 DOUBLE PRECISION NOT NULL
        CHECK (precio_mts2 > 0),
